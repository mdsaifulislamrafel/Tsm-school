            ...
            <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
                <div data-aos="fade-right" data-aos-duration="2000" className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
                    <iframe
                        ...
                        title="map"
                        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3584.475052006819!2d88.41959285548617!3d26.050726783857783!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39e4ea6ca7c1536b%3A0x6c38088fce5dc41d!2z4Kag4Ka-4KaV4KeB4Kaw4KaX4Ka-4KaB4KaTIOCmmuCmv-CmqOCmv-CmleCmsiDgpongpprgp43gppog4Kas4Ka_4Kam4KeN4Kav4Ka-4Kay4Kef!5e0!3m2!1sen!2sbd!4v1713553399436!5m2!1sen!2sbd"
                    ...
                    <div className="bg-white relative flex flex-wrap py-6 w-full rounded shadow-md">
                        <div className="lg:w-1/2 px-6">
                            ...
                            <p className="mt-1">THAKURGAON ROAD, THAKURGAON</p>
                        </div>
                        <div className="lg:w-1/2 px-6 mt-4 lg:mt-0">
                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs">EMAIL</h2>
                            <small className="text-indigo-500 leading-relaxed text-wrap">mdsaifulisalmrafel@gmail.com</small>

                            <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">PHONE</h2>
                            <p className="leading-relaxed">+880 1774117142</p>
                        </div>
                    </div>
                </div>
